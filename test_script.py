...
def Build_obs(target,mask_wise,ignore_spec):
    ...
    if mask_wise==True:
        obs['phot_mask']=[True,True,True,True,True,True,True,True,True,True,True,False,False,False,False,True,True,True,True]
    i=0
...
def build_all(target,mask_wise,model_name,ignore_spec):
