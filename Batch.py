...
'UGC9379':0.0252,
'NVSSJ09':0.02779}
masks={'MCG05':[True,True,True,True,True,True,True,True,True,True,True,False,False,True,True,True,True,True,True],
    'MCG06':[True,True,True,True,True,True,True,True,True,True,True,False,False,True,True,True,True,True,True],
    'NGC3016':[True,True,True,True,True,True,True,True,True,True,True,False,False,True,True,True,True,True,True],
    'NGC3705':[True,True,True,True,True,True,True,True,True,True,True,False,False,True,True,True,True,True,True],
    'NGC6365A':[True,True,True,True,True,True,True,True,True,True,True,False,False,True,True,True,True,True,True],
    'NVSSJ09':[True,True,True,True,True,True,True,True,True,True,True,False,False,True,True,True,True,True,True],
    'UGC9379':[True,True,True,True,True,True,True,True,True,True,True,False,False,True,True,True,True,True,True]}
...
def Build_obs(target,ignore_spec):
    obs={}
...
def build_model(model_name,obs):
...
def build_all(target,model_name,ignore_spec):
    obs=Build_obs(target,ignore_spec)
    model=build_model(model_name,obs)
    sps=build_sps(model_name)
    noise=build_noise()
    return obs,model,sps,noise

def all_in_one(target,model_name='parametric_sfh',ignore_spec=True):
    obs, model, sps, noise = build_all(target,model_name,ignore_spec)
...
if __name__ == '__main__':
    objects=['MCG05','MCG06','NGC3705','NGC3016','NGC6365A','NVSSJ09','UGC9379']
    with Pool(6) as p:
        p.map(all_in_one,objects)
